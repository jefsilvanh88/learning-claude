...
PWA gamificado em português para aprender a usar o Claude e o Claude Code de verdade: 7 níveis progressivos, 27 lições, 133 exercícios com feedback imediato, XP, estrelas e streak diário.

## Níveis

1. **Uso** — Chat, Code, Cowork e modelos
2. **Prompting** — bons prompts, contexto, CLAUDE.md, plan mode
3. **Ferramentas & MCP** — conectores, GitHub, permissões, slash commands
